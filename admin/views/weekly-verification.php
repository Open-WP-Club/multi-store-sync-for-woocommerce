...
<div class="wrap wc-mss-weekly-verification">
    <h1><?php _e('Weekly Sync Verification', 'multi-store-sync-for-woocommerce'); ?></h1>

    <?php settings_errors('wc_mss_weekly_verification'); ?>

    <p class="description">
        <?php _e('Automatically verify that all products are correctly synchronized across all stores on a weekly basis.', 'multi-store-sync-for-woocommerce'); ?>
    </p>
    ...
    <div class="wc-mss-card">
        <h2><?php _e('Verification Settings', 'multi-store-sync-for-woocommerce'); ?></h2>
        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="verification_enabled"><?php _e('Enable Weekly Verification', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <label>
                            <input type="checkbox" name="verification_enabled" id="verification_enabled" value="1"
                                   <?php checked($settings['enabled'], true); ?>>
                            <?php _e('Enable automatic weekly sync verification', 'multi-store-sync-for-woocommerce'); ?>
                        </label>
                        <p class="description"><?php _e('When enabled, the system will automatically verify product sync across all stores on a weekly schedule.', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="verification_day"><?php _e('Verification Day', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <select name="verification_day" id="verification_day">
                            <option value="0" <?php selected($settings['day_of_week'], 0); ?>><?php _e('Sunday', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="1" <?php selected($settings['day_of_week'], 1); ?>><?php _e('Monday', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="2" <?php selected($settings['day_of_week'], 2); ?>><?php _e('Tuesday', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="3" <?php selected($settings['day_of_week'], 3); ?>><?php _e('Wednesday', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="4" <?php selected($settings['day_of_week'], 4); ?>><?php _e('Thursday', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="5" <?php selected($settings['day_of_week'], 5); ?>><?php _e('Friday', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="6" <?php selected($settings['day_of_week'], 6); ?>><?php _e('Saturday', 'multi-store-sync-for-woocommerce'); ?></option>
                        </select>
                        <p class="description"><?php _e('Which day of the week to run verification', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="verification_time"><?php _e('Verification Time', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <input type="time" name="verification_time" id="verification_time" value="<?php echo esc_attr($settings['time_of_day']); ?>">
                        <p class="description"><?php _e('What time to run verification (server time). Recommended: during low traffic hours.', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label><?php _e('What to Check', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <label style="display: block; margin-bottom: 5px;">
                            <input type="checkbox" name="check_stock" value="1" <?php checked($settings['check_stock'], true); ?>>
                            <?php _e('Stock Quantities', 'multi-store-sync-for-woocommerce'); ?>
                        </label>
                        <label style="display: block; margin-bottom: 5px;">
                            <input type="checkbox" name="check_prices" value="1" <?php checked($settings['check_prices'], true); ?>>
                            <?php _e('Prices (Regular & Sale)', 'multi-store-sync-for-woocommerce'); ?>
                        </label>
                        <p class="description"><?php _e('Select what fields to verify during the check', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="sample_mode"><?php _e('Products to Check', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <select name="sample_mode" id="sample_mode">
                            <option value="all" <?php selected($settings['sample_mode'], 'all'); ?>><?php _e('All Products', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="recent" <?php selected($settings['sample_mode'], 'recent'); ?>><?php _e('Most Recent Products', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="modified" <?php selected($settings['sample_mode'], 'modified'); ?>><?php _e('Recently Modified Products', 'multi-store-sync-for-woocommerce'); ?></option>
                            <option value="random" <?php selected($settings['sample_mode'], 'random'); ?>><?php _e('Random Sample', 'multi-store-sync-for-woocommerce'); ?></option>
                        </select>
                        <p class="description"><?php _e('Which products to include in verification', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="product_limit"><?php _e('Product Limit', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php _e('Maximum number of products to check (0 = unlimited). Recommended: 100-500 for large catalogs to avoid timeouts.', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="batch_size"><?php _e('Batch Size', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description"><?php _e('Number of products to verify per batch. Higher values = faster verification but more server load. Recommended: 10-30.', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr>
                    <th scope="row">
                        <label for="auto_correct"><?php _e('Auto-Correct Discrepancies', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <label>
                            <input type="checkbox" name="auto_correct" id="auto_correct" value="1"
                                   <?php checked($settings['auto_correct'], true); ?>>
                            <?php _e('Automatically queue products for re-sync when discrepancies are found', 'multi-store-sync-for-woocommerce'); ?>
                        </label>
                        <p class="description"><?php _e('When enabled, products with discrepancies will be automatically added to the sync queue for correction.', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>

                <tr id="auto_correct_limit_row" style="<?php echo !$settings['auto_correct'] ? 'display:none;' : ''; ?>">
                    <th scope="row">
                        <label for="auto_correct_limit"><?php _e('Auto-Correct Limit', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        ...
                        <span><?php _e('products max', 'multi-store-sync-for-woocommerce'); ?></span>
                        <p class="description">
                            <?php _e('Maximum number of products to auto-correct per verification run. Set to 0 for unlimited (not recommended). Default: 500.', 'multi-store-sync-for-woocommerce'); ?>
                        </p>
                    </td>
                </tr>
                ...
                <tr id="auto_correct_sync_type_row" class="auto-correct-option" style="<?php echo !$settings['auto_correct'] ? 'display:none;' : ''; ?>">
                    <th scope="row">
                        <label for="weekly_sync_type"><?php _e('Auto-Correct Sync Type', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php _e('What type of data to sync when auto-correcting discrepancies.', 'multi-store-sync-for-woocommerce'); ?>
                        </p>
                    </td>
                </tr>
                ...
                <tr id="auto_correct_stock_sync_row" class="auto-correct-option" style="<?php echo !$settings['auto_correct'] ? 'display:none;' : ''; ?>">
                    <th scope="row">
                        <label for="weekly_stock_sync"><?php _e('Stock Synchronization', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <select name="weekly_stock_sync" id="weekly_stock_sync">
                            <option value="use_default" <?php selected($weekly_stock_sync, 'use_default'); ?>>
                                <?php _e('Use General Settings', 'multi-store-sync-for-woocommerce'); ?>
                            </option>
                            <option value="enabled" <?php selected($weekly_stock_sync, 'enabled'); ?>>
                                <?php _e('Enabled', 'multi-store-sync-for-woocommerce'); ?>
                            </option>
                            <option value="disabled" <?php selected($weekly_stock_sync, 'disabled'); ?>>
                                <?php _e('Disabled', 'multi-store-sync-for-woocommerce'); ?>
                            </option>
                        </select>
                        <p class="description">
                            <?php _e('Whether to sync stock quantities when auto-correcting.', 'multi-store-sync-for-woocommerce'); ?>
                        </p>
                    </td>
                </tr>
                ...
                <tr id="auto_correct_category_row" class="auto-correct-option" style="<?php echo !$settings['auto_correct'] ? 'display:none;' : ''; ?>">
                    <th scope="row">
                        <label for="weekly_category_auto_create"><?php _e('Auto-create Categories', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php _e('Whether to auto-create missing categories on remote stores when auto-correcting.', 'multi-store-sync-for-woocommerce'); ?>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <th scope="row">
                        <label for="email_enabled"><?php _e('Email Notifications', 'multi-store-sync-for-woocommerce'); ?></label>
                    </th>
                    <td>
                        <label style="display: block; margin-bottom: 10px;">
                            <input type="checkbox" name="email_enabled" id="email_enabled" value="1"
                                   <?php checked($settings['email_enabled'], true); ?>>
                            <?php _e('Send email when discrepancies are found', 'multi-store-sync-for-woocommerce'); ?>
                        </label>

                        <label for="email_recipients"><?php _e('Email Recipients:', 'multi-store-sync-for-woocommerce'); ?></label><br>
                        ...
                        <p class="description"><?php _e('Comma-separated list of email addresses to notify when discrepancies are found.', 'multi-store-sync-for-woocommerce'); ?></p>
                    </td>
                </tr>
            </table>
    ...
    <div class="wc-mss-card">
        <h2><?php _e('Manual Verification & Sync Control', 'multi-store-sync-for-woocommerce'); ?></h2>

        <?php if ($next_run): ?>
            <p>
                <strong><?php _e('Next Scheduled Run:', 'multi-store-sync-for-woocommerce'); ?></strong>
                <?php echo date('l, F j, Y \a\t g:i A', $next_run); ?>
                (<?php echo human_time_diff($next_run, current_time('timestamp')); ?>)
            </p>
        <?php else: ?>
            <p><em><?php _e('No verification scheduled. Enable weekly verification above to schedule.', 'multi-store-sync-for-woocommerce'); ?></em></p>
        <?php endif; ?>

        <div style="margin: 15px 0;">
            <button type="button" id="wc-mss-start-verification-page" class="button button-secondary">
                <?php _e('Run Verification Now', 'multi-store-sync-for-woocommerce'); ?>
            </button>
            ...
            <span class="description" style="margin-left: 10px;"><?php _e('Runs verification in the background.', 'multi-store-sync-for-woocommerce'); ?></span>
        </div>

        <h3><?php _e('Stop Synchronization', 'multi-store-sync-for-woocommerce'); ?></h3>
        <p class="description"><?php _e('Use these buttons to stop sync operations. Products queued by auto-correct will be removed.', 'multi-store-sync-for-woocommerce'); ?></p>
        <div style="margin: 15px 0;">
            <button type="button" id="stop-weekly-sync" class="button button-secondary" style="color: #d63638; border-color: #d63638;">
                ...
                <?php _e('Stop Weekly Verification', 'multi-store-sync-for-woocommerce'); ?>
            </button>
            <button type="button" id="stop-all-sync" class="button button-secondary" style="color: #fff; background-color: #d63638; border-color: #d63638; margin-left: 10px;">
                ...
                <?php _e('Stop All Sync & Clear Queue', 'multi-store-sync-for-woocommerce'); ?>
            </button>
        </div>
        ...
        <div id="wc-mss-verification-progress-page" style="display: none; margin-top: 15px; padding: 15px; background: #fff; border: 1px solid #ddd; border-radius: 4px;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                <span id="wc-mss-verification-status-page"><?php _e('Starting...', 'multi-store-sync-for-woocommerce'); ?></span>
    ...
    <?php if ($latest_report): ?>
        <div class="wc-mss-card">
            <h2><?php _e('Latest Verification Report', 'multi-store-sync-for-woocommerce'); ?></h2>

            <div class="wc-mss-report-summary">
                <p>
                    <strong><?php _e('Run Date:', 'multi-store-sync-for-woocommerce'); ?></strong>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin: 20px 0;">
                    <div style="background: #f0f0f1; padding: 15px; border-radius: 4px;">
                        ...
                        <div style="color: #646970;"><?php _e('Products Checked', 'multi-store-sync-for-woocommerce'); ?></div>
                    </div>
                    <div style="background: #f0f0f1; padding: 15px; border-radius: 4px;">
                        <div style="font-size: 24px; font-weight: bold; color: #2271b1;"><?php echo number_format($latest_report['stores_checked']); ?></div>
                        <div style="color: #646970;"><?php _e('Stores Checked', 'multi-store-sync-for-woocommerce'); ?></div>
                    </div>
                    <div style="background: <?php echo $latest_report['discrepancies_found'] > 0 ? '#fff3cd' : '#d1f0d1'; ?>; padding: 15px; border-radius: 4px;">
                        ...
                        <div style="color: #646970;"><?php _e('Discrepancies Found', 'multi-store-sync-for-woocommerce'); ?></div>
                    </div>
                    <div style="background: #f0f0f1; padding: 15px; border-radius: 4px;">
                        <div style="font-size: 24px; font-weight: bold; color: #2271b1;"><?php echo number_format($latest_report['duration_seconds'], 1); ?>s</div>
                        <div style="color: #646970;"><?php _e('Duration', 'multi-store-sync-for-woocommerce'); ?></div>
                    </div>
                </div>

                <?php if ($latest_report['discrepancies_found'] > 0): ?>
                    <div style="margin-top: 15px;">
                        <h3><?php _e('Breakdown', 'multi-store-sync-for-woocommerce'); ?></h3>
                        <ul>
                            <li><strong><?php _e('Missing Products:', 'multi-store-sync-for-woocommerce'); ?></strong> <?php echo number_format($latest_report['missing_products']); ?></li>
                            <?php
                            ...
                            <li style="color: #d63638;">
                                <strong><?php _e('Orphan Products:', 'multi-store-sync-for-woocommerce'); ?></strong> <?php echo number_format($orphan_count); ?>
                                <em>(<?php _e('exist on remote but should be excluded', 'multi-store-sync-for-woocommerce'); ?>)</em>
                                <button type="button" id="wc-mss-queue-orphans" class="button button-small" style="margin-left: 10px; background: #d63638; border-color: #d63638; color: #fff;">
                                    <?php _e('Queue for Deletion', 'multi-store-sync-for-woocommerce'); ?>
                                </button>
                                <span id="wc-mss-orphan-status" style="margin-left: 10px;"></span>
                            </li>
                            <?php endif; ?>
                            <li><strong><?php _e('Stock Mismatches:', 'multi-store-sync-for-woocommerce'); ?></strong> <?php echo number_format($latest_report['stock_mismatches']); ?></li>
                            <li><strong><?php _e('Price Mismatches:', 'multi-store-sync-for-woocommerce'); ?></strong> <?php echo number_format($latest_report['price_mismatches']); ?></li>
                        </ul>
                        ...
                        if (!empty($report_data['details'])):
                            $shown = 0;
                        ?>
                            <h3><?php _e('Sample Discrepancies (First 5)', 'multi-store-sync-for-woocommerce'); ?></h3>
                ...
                <?php else: ?>
                    <div style="background: #d1f0d1; border-left: 4px solid #46b450; padding: 15px; margin: 15px 0;">
                        <strong><?php _e('All products are in sync!', 'multi-store-sync-for-woocommerce'); ?></strong>
                        <p><?php _e('No discrepancies were found during this verification.', 'multi-store-sync-for-woocommerce'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <?php if (!empty($reports)): ?>
        <div class="wc-mss-card">
            <h2><?php _e('Recent Verification Reports', 'multi-store-sync-for-woocommerce'); ?></h2>

            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th><?php _e('Date', 'multi-store-sync-for-woocommerce'); ?></th>
                        <th><?php _e('Products Checked', 'multi-store-sync-for-woocommerce'); ?></th>
                        <th><?php _e('Stores', 'multi-store-sync-for-woocommerce'); ?></th>
                        <th><?php _e('Discrepancies', 'multi-store-sync-for-woocommerce'); ?></th>
    ...
    <?php endif; ?>
        ...
        <div class="wc-mss-sidebar">
            <div class="wc-mss-sidebar-card">
                <h3><?php _e('System Health', 'multi-store-sync-for-woocommerce'); ?></h3>

                <div class="wc-mss-health-local">
                    <span class="dashicons dashicons-store"></span>
                    <strong><?php _e('Local Store', 'multi-store-sync-for-woocommerce'); ?></strong>
                    <div class="wc-mss-health-stats">
                        <span class="stat"><?php echo $local_cat_count; ?> <?php _e('Cat', 'multi-store-sync-for-woocommerce'); ?></span>
                        <span class="stat"><?php echo $local_tag_count; ?> <?php _e('Tags', 'multi-store-sync-for-woocommerce'); ?></span>
                    </div>
                </div>
                ...
                <?php if (empty($store_health)): ?>
                    <p class="wc-mss-no-stores">
                        ...
                        <?php _e('No active stores', 'multi-store-sync-for-woocommerce'); ?>
                    </p>
                <?php else: ?>
                    ...
                    <div class="wc-mss-health-store <?php echo $status_class; ?>">
                        ...
                        <?php if ($no_cache): ?>
                            <small class="store-status"><?php _e('No cache yet', 'multi-store-sync-for-woocommerce'); ?></small>
                        <?php else: ?>
                            <div class="store-counts">
                                <div class="sync-row" title="<?php echo $cat_missing > 0 ? esc_attr(__('Missing: ', 'multi-store-sync-for-woocommerce') . implode(', ', array_slice($health['categories']['missing'], 0, 10))) : ''; ?>">
                                    <span class="sync-label"><?php _e('Categories:', 'multi-store-sync-for-woocommerce'); ?></span>
                                    <span class="sync-status <?php echo $cat_missing === 0 ? 'synced' : 'partial'; ?>">
                                        ...
                                        <?php else: ?>
                                            <em class="missing">(<?php echo $cat_missing; ?> <?php _e('missing', 'multi-store-sync-for-woocommerce'); ?>)</em>
                                        <?php endif; ?>
                                    </span>
                                </div>
                                <div class="sync-row">
                                    <span class="sync-label"><?php _e('Tags:', 'multi-store-sync-for-woocommerce'); ?></span>
                                    <span class="sync-status <?php echo $tag_missing === 0 ? 'synced' : 'partial'; ?>">
                                        ...
                                        <?php if ($tag_missing === 0): ?>
                                            <span class="dashicons dashicons-yes"></span>
                                        <?php else: ?>
                                            <em class="missing">(<?php echo $tag_missing; ?> <?php _e('missing', 'multi-store-sync-for-woocommerce'); ?>)</em>
                                        <?php endif; ?>
                                    </span>
                                </div>
                            </div>
                    ...
                    <p class="wc-mss-health-note">
                        <small>
                            <?php printf(__('Match: %s', 'multi-store-sync-for-woocommerce'), $match_by); ?><br>
                            <?php _e('Cache: 24h', 'multi-store-sync-for-woocommerce'); ?>
                        </small>
                    </p>
                <?php endif; ?>
            </div>
